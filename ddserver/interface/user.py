  ...
  def wrapper(func):
    ...
    def wrapped(users,
      ...
      if (bottle.request.query.username == "" or
        ...
        messages.error('You need to provide username and authcode.')
        bottle.redirect('/')
      ...
      if user == None:
        messages.error('This username does not exist.')
        bottle.redirect('/')

      if user.authcode != authcode:
        messages.error('The authcode you provided is invalid.')
        bottle.redirect('/')
